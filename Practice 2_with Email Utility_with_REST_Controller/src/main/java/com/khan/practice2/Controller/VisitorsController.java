...
import com.khan.practice2.util.EmailUtil;
...
public class VisitorsController {
	...
	public String saveVisitors(@ModelAttribute("visitors") Visitors visitors,ModelMap modelMap){
		...
		emailUtil.sendEmail("iakapi333@gmail.com","Visitor Saved",
				"Visitor Saved successfully and about to return a response");
